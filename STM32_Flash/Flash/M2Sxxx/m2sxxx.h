 ...
 *
 * SVN $Revision: 4787 $
 * SVN $Date: 2012-11-30 14:58:27 +0000 (Fri, 30 Nov 2012) $
 */
...
#define SYSREG_ENVM0_SOFTRESET_MASK         ( (uint32_t)( 0x01 << 0) )
#define SYSREG_ENVM1_SOFTRESET_MASK         ( (uint32_t)( 0x01 << 1) )
#define SYSREG_ESRAM0_SOFTRESET_MASK        ( (uint32_t)( 0x01 << 2) )
#define SYSREG_ESRAM1_SOFTRESET_MASK        ( (uint32_t)( 0x01 << 3) )
#define SYSREG_MAC_SOFTRESET_MASK           ( (uint32_t)( 0x01 << 4) )
#define SYSREG_PDMA_SOFTRESET_MASK          ( (uint32_t)( 0x01 << 5) )
#define SYSREG_TIMER_SOFTRESET_MASK         ( (uint32_t)( 0x01 << 6) )
#define SYSREG_MMUART0_SOFTRESET_MASK       ( (uint32_t)( 0x01 << 7) )
#define SYSREG_MMUART1_SOFTRESET_MASK       ( (uint32_t)( 0x01 << 8) )
...
#define SYSREG_CAN_SOFTRESET_MASK           ( (uint32_t)( 0x01 << 13) )
#define SYSREG_USB_SOFTRESET_MASK           ( (uint32_t)( 0x01 << 14) )
#define SYSREG_COMBLK_SOFTRESET_MASK        ( (uint32_t)( 0x01 << 15) )
#define SYSREG_FPGA_SOFTRESET_MASK          ( (uint32_t)( 0x01 << 16) )
#define SYSREG_HPDMA_SOFTRESET_MASK         ( (uint32_t)( 0x01 << 17) )
#define SYSREG_FIC32_0_SOFTRESET_MASK       ( (uint32_t)( 0x01 << 18) )
#define SYSREG_FIC32_1_SOFTRESET_MASK       ( (uint32_t)( 0x01 << 19) )
#define SYSREG_GPIO_SOFTRESET_MASK          ( (uint32_t)( 0x01 << 20) )
#define SYSREG_GPIO_7_0_SOFTRESET_MASK      ( (uint32_t)( 0x01 << 21) )
#define SYSREG_GPIO_15_8_SOFTRESET_MASK     ( (uint32_t)( 0x01 << 22) )
#define SYSREG_GPIO_23_16_SOFTRESET_MASK    ( (uint32_t)( 0x01 << 23) )
#define SYSREG_GPIO_31_24_SOFTRESET_MASK    ( (uint32_t)( 0x01 << 24) )
#define SYSREG_MDDR_SOFTRESET_MASK          ( (uint32_t)( 0x01 << 25) )
#define SYSREG_FIC64_SOFTRESET_MASK         ( (uint32_t)( 0x01 << 26) )
...
#define DDR0_CFG_BASE           0x40020000u
#define DDR1_CFG_BASE           0x40020800u
