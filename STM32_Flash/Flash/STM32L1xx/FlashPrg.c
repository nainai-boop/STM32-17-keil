...
/*               for ST Microelectronics STM32L1xx Flash               */
/*                                                                     */
/***********************************************************************/
...
#if defined STM32L1xx_256 || defined STM32L1xx_384  // Mid+-Density, High-Density device
  vu32 RESERVED[23];                            // 
  vu32 WRPR1;                                   // offset  0x080 Flash write protection register (FLASH_WRPR1)
#endif
#if defined STM32L1xx_384                       // High-Density device
  vu32 WRPR2;                                   // offset  0x084 Flash write protection register (FLASH_WRPR2)
#endif
...
#if defined STM32L1xx_256 || defined STM32L1xx_384  // Mid+-Density, High-Density device
  M32(0x1FF80010) = 0xFFFF0000;                 // unprotect sectors
  M32(0x1FF80014) = 0xFFFF0000;
#endif
#if defined STM32L1xx_384                       // High-Density device
  M32(0x1FF80018) = 0xFFFF0000;
  M32(0x1FF8001C) = 0xFFFF0000;
#endif
...
#if defined STM32L1xx_384                       // High-Density device
  sz = (sz + 31) & ~31;                         // Adjust programming size to 32 Bytes
#elif defined STM32L1xx_256                     // Mid+-Density device
  sz = (sz + 23) & ~23;                         // Adjust programming size to 24 Bytes
#else                                           // Low-, Mid-Density device
  sz = (sz + 15) & ~15;                         // Adjust programming size to 16 Bytes
#endif
