...
#define FCR0    (*((volatile unsigned long  *) 0x40100000))
#define FCR1    (*((volatile unsigned long  *) 0x40100004))
#define FDR0    (*((volatile unsigned long  *) 0x40100008))
#define FDR1    (*((volatile unsigned long  *) 0x4010000C))
#define FAR     (*((volatile unsigned long  *) 0x40100010))
#define FER     (*((volatile unsigned long  *) 0x40100014))
#define FNVWPAR (*((volatile unsigned long  *) 0x4010DFB0))
#define FNVAPR0 (*((volatile unsigned long  *) 0x4010DFB8))
#define FNVAPR1 (*((volatile unsigned long  *) 0x4010DFBC))
...
int EraseSector (unsigned long adr) {
  ...
  if (adr < 0x40000000) return (1);            // Invalid Address
  if (adr > 0x400FFFFF) return (1);            // Invalid Address
